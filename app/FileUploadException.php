...
class FileUploadException extends Model
{
    /**
 ...
 *                public directory
 */
    public static function saveUploadedImage($inputName) 
    {
        $maxUploadSize = 9999999999;
        // old file upload max size: 4024000000

       $validFileExtensions = ['jpg', 'jpeg', 'png', 'gif', 'JPG', 'PNG', 'GIF', 'JPEG'];
        $uploadsDirectory = 'images/uploads/user-uploads/profile-pictures';
